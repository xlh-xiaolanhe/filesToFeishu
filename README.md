...
当前版本：**v0.2.3**。支持代码区域识别、本地代码截图 OCR、块内编辑、跨页代码合并和原生代码块发布，保留各页原始区域供折叠校对。本版清理有来源依据的重复列表符号和 PDF 页码，整页降级图片也去除已识别的页号，原件与原文预览保持原貌；详见 [验证记录](docs/validation/v0.2.3.md)和[文档索引](docs/README.md)。
