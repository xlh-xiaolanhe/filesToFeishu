...
当前状态：**v0.2.2 已交付**。支持代码区域识别、本地代码截图 OCR、块内编辑、跨页代码合并和原生代码块发布，保留各页原始区域供折叠校对。本版修复表格写入中断恢复和非 JSON 限流响应处理，已续接真实任务并通过归档后回读核验；详见 [验证记录](docs/validation/v0.2.2.md)和[文档索引](docs/README.md)。
